...
module.exports.superUser = async function(req,res){
  ...
  try {
    ...
    await User.create({
      userType:"admin",
      name:"Gautam Gupta",
      email:"gautamgupta7704@gmail.com",
      password:"gautam@123",
      confirmPassword:"gautam@123",
      department:"HR"
    })
    return res.end(`<h3>user credentials</h3> <p>email:  gautamgupta7704@gmail.com <br> paasword :  gautam@123</p> <h2>please delete Gautam Gupta as soon as you create new user</h2> </h2> `)
  } catch (error) {
    console.log(error);
